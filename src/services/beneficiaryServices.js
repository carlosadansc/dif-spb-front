...
const getBeneficiariesCount = async (params, headers) => {
    return await api.get('/beneficiaries/count', { params, headers } ).then((response) =>  response.data ).catch((err) => err)
}
...
const createFamily = async (beneficiaryId, family, headers) => {
    return await api.post(`/beneficiary/${beneficiaryId}/family-create/`, family, { headers }).then((response) =>  response.data ).catch((err) => err)
}

const getBeneficiaryFamilies = async (beneficiaryId, headers) => {
    return await api.get(`/beneficiary/${beneficiaryId}/family`, { headers }).then((response) =>  response.data ).catch((err) => err)
}

const getFamilyByBeneficiary = async (id, headers) => {
    return await api.get(`/family/by-beneficiary/${id}`, { headers }).then((response) =>  response.data ).catch((err) => err)
}

const generateProvisionalCurp = async (headers) => {
    return await api.get('/generate-curp', { headers }).then((response) =>  response.data ).catch((err) => err)
}

const getBeneficiariesByDelegation = async (headers) => {
    return await api.get('/beneficiaries/by-delegations', { headers }).then((response) =>  response.data ).catch((err) => err)
}

const getBeneficiariesBySex = async (headers) => {
    return await api.get('/beneficiaries/by-sex', { headers }).then((response) =>  response.data ).catch((err) => err)
}
